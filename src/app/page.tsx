...
function SellYourCardsCTA() {
  return (
    <section className="bg-nimbus-50 border-y border-nimbus-300">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        <div className="flex flex-col items-center text-center gap-6 sm:gap-8">
          <div className="inline-flex items-center gap-2 rounded-full border border-nimbus-400 bg-nimbus-100/50 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-nimbus-600">
            Got cards to sell?
          </div>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-text-primary tracking-tight max-w-2xl">
            Turn your collection into{' '}
            <span className="text-nimbus-600">cash</span> — fast.
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3">
            ...
            <Link
              href="/help/grading"
              className="rounded-xl border border-nimbus-400 px-8 py-3 text-sm font-semibold text-text-secondary transition-colors hover:border-nimbus-500 hover:text-text-primary"
            >
              How it works
            </Link>
          </div>
