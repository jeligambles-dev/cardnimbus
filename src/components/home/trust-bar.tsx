const TRUST_ITEMS = [
  ...
  },
  {
    ...
    title: 'Top Rated',
    subtitle: '4.9/5 from 1,000+ buyers',
  },
]
        ...
        <div className="grid grid-cols-2 gap-6 sm:grid-cols-4 sm:gap-4">
          {TRUST_ITEMS.map(({ icon, title, subtitle }) => (
            <div key={title} className="flex items-center gap-3">
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-nimbus-50 text-nimbus-600">
                {icon}
              </div>
              <div>
